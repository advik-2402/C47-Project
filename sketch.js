...
var bulletsGroup, enemyBulletsGroup, tankBulletsGroup, bombGroup;
...
function draw() {
    ...
    if (bulletsGroup.isTouching(enemy2.body)) {
        score += 5;
        enemy2.body.destroy();
        enemy2.body.lifetime = 0;
    }

    if (bulletsGroup.isTouching(enemy3.body)) {
        score += 5;
        enemy3.body.destroy();
        enemy3.body.lifetime = 0;
    }

    if (tankBulletsGroup.isTouching(enemy1.body)) {
        score += 5;
        enemy1.body.destroy();
        enemy1.body.lifetime = 0;
    }
    ...
    if (tankBulletsGroup.isTouching(enemy2.body)) {
        score += 5;
        enemy2.body.destroy();
        enemy2.body.lifetime = 0;
    }
    ...
    if (tankBulletsGroup.isTouching(enemy3.body)) {
        score += 5;
        enemy3.body.destroy();
        enemy3.body.lifetime = 0;
    }

    if (bombGroup.isTouching(enemy1.body)) {
        score += 5;
        enemy1.body.destroy();
        enemy1.body.lifetime = 0;
    }

    if (bombGroup.isTouching(enemy2.body)) {
        score += 5;
        enemy2.body.destroy();
        enemy2.body.lifetime = 0;
    }

    if (bombGroup.isTouching(enemy3.body)) {
        score += 5;
        enemy3.body.destroy();
        enemy3.body.lifetime = 0;
    }
    ...
    if (frameCount % 230 === 0) {
        if (enemy2.body.lifetime !== 0) {
            enemy2.display();
        }
    }

    if (frameCount % 280 === 0) {
        if (enemy3.body.lifetime !== 0) {
            enemy3.display();
        }
    }
